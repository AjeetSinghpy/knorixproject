@extends('layouts.vertical', ['title' => ' All Events', 'sub_title' => 'Apps', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <div class="mt-6">
        ...
        <div class="flex justify-between items-center gap-2 p-6">
            ...
            <div class="flex gap-2">
                <a href="{{ route('second', ['event', 'add-event']) }}" class="btn bg-dark/25 text-sm font-medium text-slate-900 dark:text-slate-200/70 hover:text-white hover:bg-dark/90">Add New Event</a>
            </div>
        </div>
                       ...
                       <td class="py-4 px-3 text-sm">
                        ...
                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                            <div class="flex items-center">
                                <a href="{{ route('second', ['event', 'edit-event']) }}" class="">Featured Event of Washington, D.C. Highlights</a>
                            </div>
                        </td>
						<td class="whitespace-nowrap py-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"></td>
						<td class="whitespace-nowrap py-4 px-3 text-sm">Customer 01</td>
						...
						<td class="whitespace-nowrap py-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200">23/04/2024</td>
                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                            <div class="flex items-center">
                                <a href="{{ route('second', ['event', 'edit-event']) }}" class="">Edit </a>
                            </div>
                        </td>
					</tr>
