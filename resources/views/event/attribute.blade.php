...
@extends('layouts.vertical', ['title' => 'Event Attributes', 'sub_title' => 'Apps', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
<div class="mt">
    <div class="flex gap-4">
        <div class="flex-1">
            ...
            <div class="card h-96"> 
                <div class="flex flex-wrap justify-between items-center gap-2 p-6">
                    <h2 class="text-xl font-bold">Add Attributes</h2>
                    ...
                    <form class="w-full">
                        ...
                        <div class="w-full mb-4">
                            ...
                            <input type="number" id="price" name="price" min="0"  step="1" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Ex:1">
                                The position will be used to order in the Filter</br> page search. The greater number is priority
                       </div>
                       <div class="mb-4 w-full">
                            <label for="price" class="block text-sm font-medium text-gray-700">Display Type in detail service</label>

                            <select class="form-select text-sm border-gray-300 rounded-lg">
                                <option value="" disabled selected>Display left icon </option>
                                <option value="delete">Display Center icon</option>
                            </select>
        ...
        <div class="flex-1">
            ...
            <div class="card h-96"> 
                <div class="flex flex-wrap justify-between items-center gap-2 p-6">
                    <h2 class="text-xl font-bold">All Attribute</h2>
                    <hr class="w-full border-t border-gray-300 mt-2">
                            ...
                            <table class="w-full divide-y divide-gray-300 dark:divide-gray-700">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-gray-200">Position Order</th>
                                        ...
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                                <div class="flex items-center">
                                                    <div class="whitespace-nowrap py-4 px-3 text-sm">
                                                        <a href="{{ route('second', ['event', 'edit-attribute']) }}" class="text-blue-600 hover:text-blue-800">
                                                            Event type
                                                        </a>
                                                    </div>
                                                </div>
                                        </td>
                                        <td class="whitespace-nowrap py-4 px-3 text-sm">0</td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <a href="{{ route('second', ['event', 'edit-attribute']) }}" class="text-blue-600 hover:text-blue-800">Edit</a> |
                                            <a href="{{ route('second', ['event', 'attribute-term']) }}" class="text-blue-600 hover:text-blue-800">Manage Terms</a>
                                        </td>                                          
                                     </tr>
