@extends('layouts.vertical', ['title' => 'Add New Car', 'sub_title' => 'Apps', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    <div class="flex gap-4">
            ...
            <div class="card">
                <div class="flex flex-wrap justify-between items-center gap-2 p-6">
                    ...
                    <form class="w-full">
                        ...
                        <div class="w-full mb-4">
                                <label for="title" class="block text-sm font-medium text-gray-700">Start Time</label>
                                <input type="text" id="title" name="title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Ex:15:00">
                        </div>

                        <div class="w-full mb-4">
                                <label for="price" class="block text-sm font-medium text-gray-700">Duration(hour)</label>
                            ...
                            <div class="w-full mb-4">
                                ...
                                <div class="border border-gray-300 p-4 rounded-md">
                                    <table class="w-full table-auto border-separate border-spacing-4">
                                        <thead>
                                            <tr>
                                                <th class="text-left text-sm font-medium text-gray-700">Code</th>
                                                <th class="text-left text-sm font-medium text-gray-700">Name</th>
                                                <th class="text-left text-sm font-medium text-gray-700">Price-Number</th>
                                            </tr>
                                        </thead>
        ...
        <div class="flex-1">
			...
			<div class="card">
                <div class="flex flex-wrap justify-between items-center gap-2 p-6">
                    <h2 class="text-xl font-bold">Attribute:Event type</h2>
                    <hr class="w-full border-t border-gray-300 mt-2">
