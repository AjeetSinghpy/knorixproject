...
@section('content')
    ...
    <div class="flex justify-between items-center gap-2 p-6">
            ...
            <div class="flex gap-2">
                <a href="{{ route('second', ['coupon', 'add-coupon']) }}" class="btn bg-dark/25 text-sm font-medium text-slate-900 dark:text-slate-200/70 hover:text-white hover:bg-dark/90">Add New Coupon</a>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2 p-6">
            ...
            <button type="button" class="btn bg-dark/25 text-sm font-medium text-slate-900 dark:text-slate-200/70 hover:text-whitDe hover:bg-dark/90 mr-6">
                Apply
            </button>
			...
			<table class="w-full divide-y divide-gray-300 dark:divide-gray-700">
				<thead class="">
					<tr>
						...
						<th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-gray-200">Discount Type</th>
						<th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-gray-200">End Date</th>
				...
				<tbody class="divide-y divide-gray-200 dark:divide-gray-700 ">
                   <tr>
                        ...
                        <td class="whitespace-nowrap py-4 px-3 text-sm">no coupon found </td>
