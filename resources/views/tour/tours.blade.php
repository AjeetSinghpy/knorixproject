@extends('layouts.vertical', ['title' => ' All Tours', 'sub_title' => 'Apps', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <div class="mt-6">
        ...
        <div class="flex justify-between items-center gap-2 p-6">
            ...
            <div class="flex gap-2">
                <a href="{{ route('second', ['tour', 'add-tour']) }}" class="btn bg-dark/25 text-sm font-medium text-slate-900 dark:text-slate-200/70 hover:text-white hover:bg-dark/90">Add New Tour</a>
            </div>
        </div>
                       ...
                       <td class="py-4 px-3 text-sm">
                        ...
                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                            <div class="flex items-center">
                                <a href="{{ route('second', ['tour', 'edit-tour']) }}" class="">Hollywood Sign Small Group Tour in Luxury Van </a>
                            </div>
                        </td>
                        ...
                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                            <div class="flex items-center">
                                <a href="{{ route('second', ['tour', 'edit-tour']) }}" class="">Edit </a>
                            </div>
                        </td>
					</tr>
