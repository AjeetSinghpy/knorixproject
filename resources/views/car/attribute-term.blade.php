@extends('layouts.vertical', ['title' => 'Edit: car ', 'sub_title' => 'Apps', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                                        ...
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                                <div class="flex items-center">
                                                    <div class="whitespace-nowrap py-4 px-3 text-sm">
                                                        <a href="{{ route('second', ['car', 'edit-attribute-term']) }}" class="text-blue-600 hover:text-blue-800">
                                                        Convertibles
                                                        </a>
                                                    </div>
                                                </div>
