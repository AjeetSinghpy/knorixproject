@extends('layouts.vertical', ['title' => 'Add New Boat', 'sub_title' => 'Apps', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
    <div class="flex gap-4">
        ...
        <div class="flex-1 flex flex-col gap-4">
            <div class="card">
                <div class="flex flex-wrap justify-between items-center gap-2 p-6">
                    <h2 class="text-xl font-bold">Boat Content</h2>
                ...
                <div class="flex flex-wrap justify-between items-center gap-2 p-6">
                    ...
                    <form class="w-full">
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div class="w-full mb-4">
                                <label for="price" class="block text-sm font-medium text-gray-700">Guest</label>
                            ...
                            <div class="w-full mb-4">
                                <label for="role" class="block text-sm font-medium text-gray-700">Cabin</label>
                                <input type="text" id="title" name="title" required
									class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            ...
                            <div class="w-full mb-4">
                                <label for="role" class="block text-sm font-medium text-gray-700">Length</label>
                                <input type="number" id="price" name="price" min=""  step="1" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Ex: 30mm">
                            </div>

                            <div class="w-full mb-4">
                                <label for="role" class="block text-sm font-medium text-gray-700">Speed</label>
                                <input type="number" id="price" name="price" min=""  step="1" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Ex: 25 km/h">
                            </div>
                        </div>
                         ...
                         <div class="w-full mb-4">
                            ...
                            <div class="mb-4">
                                <label for="content" class="block text-sm font-medium text-gray-700">Cancellation Policy</label>
                                <textarea id="content" name="content" required
                                    class="mit-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    placeholder="full refund up to four day prior." rows="4"></textarea>
                            </div>

                            <div class="mb-4">
                                <label for="content" class="block text-sm font-medium text-gray-700">Additional Terms and Information</label>
                                <textarea id="content" name="content" required
                                    class="mit-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                    placeholder="full refund up to four day prior." rows="4"></textarea>
                            </div>
                    ...
                    <form class="w-full">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center gap-4 mb-4">
                                ...
                                <div class="w-full mb-4">
                                    <label for="role" class="block text-sm font-medium text-gray-700">Start Time Booking</label>
                                    <select id="role" name="role" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                ...
                                <div class="w-full mb-4">
                                    <label for="role" class="block text-sm font-medium text-gray-700">End Time Booking</label>
                                    <select id="role" name="role" required
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        <option value="">-- select--</option>
                                        <option value="">00:00</option>
        ...
        <div class="flex-1">
			...
			<div class="card">
                <div class="flex flex-wrap justify-between items-center gap-2 p-6">
                    <h2 class="text-xl font-bold">Attribute:Boat type</h2>
                    <hr class="w-full border-t border-gray-300 mt-2">
			...
			<div class="card">
                <div class="flex flex-wrap justify-between items-center gap-2 p-6">
                    <h2 class="text-xl font-bold">Attribute:Aamenities</h2>
                    <hr class="w-full border-t border-gray-300 mt-2">
					<div class="w-full">
                            <input type="checkbox" id="hide_service" name="hide_service" class="form-checkbox h-5 w-5 text-blue-600">
                            Events and Meetings
