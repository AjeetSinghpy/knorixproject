@extends('layouts.vertical', ['title' => ' All Boats', 'sub_title' => 'Apps', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <div class="mt-6">
        ...
        <div class="flex justify-between items-center gap-2 p-6">
            ...
            <div class="flex gap-2">
                <a href="{{ route('second', ['boat', 'add-boat']) }}" class="btn bg-dark/25 text-sm font-medium text-slate-900 dark:text-slate-200/70 hover:text-white hover:bg-dark/90">Add New Boat</a>
            </div>
        </div>
                       ...
                       <td class="py-4 px-3 text-sm">
                        ...
                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                            <div class="flex items-center">
                                <a href="{{ route('second', ['boat', 'edit-boat']) }}" class="">My Way 100</a>
                            </div>
                        </td>
                        ...
                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                            <div class="flex items-center">
                                <a href="{{ route('second', ['boat', 'edit-boat']) }}" class="">Edit </a>
                            </div>
                        </td>
					</tr>
