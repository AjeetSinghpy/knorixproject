...
@extends('layouts.vertical', ['title' => 'Boat Attributes', 'sub_title' => 'Apps', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                                <div class="flex items-center">
                                                    <div class="whitespace-nowrap py-4 px-3 text-sm">
                                                        <a href="{{ route('second', ['boat', 'edit-attribute']) }}" class="text-blue-600 hover:text-blue-800">
                                                            Boat type
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <a href="{{ route('second', ['boat', 'edit-attribute']) }}" class="text-blue-600 hover:text-blue-800">Edit</a> |
                                            <a href="{{ route('second', ['boat', 'attribute-term']) }}" class="text-blue-600 hover:text-blue-800">Manage Terms</a>
                                        </td>                                          
                                     </tr>
