                        ...
                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                            <div class="flex items-center">
                                <div class="whitespace-nowrap py-4 px-3 text-sm">
                                    <a href="{{ route('second', ['space', 'spaces']) }}" class="text-blue-600 hover:text-blue-800">
                                        Auditourium space name term
                                    </a>
                                </div>
                            </div>
                        </td>
                        <td class="whitespace-nowrap py-4 px-3 text-sm">Paris</td>  
                        <td class="whitespace-nowrap py-4 px-3 text-sm">Zorita Merritt</td> 
                        <td class="whitespace-nowrap py-4 px-3 text-sm">Draft</td>
                        <td class="whitespace-nowrap py-4 px-3 text-sm">0</td>
                        <td class="whitespace-nowrap py-4 px-3 text-sm">12/03/2021</td>
