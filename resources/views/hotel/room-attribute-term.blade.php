@extends('layouts.vertical', ['title' => 'Attribute: Room Attribute name', 'sub_title' => 'Apps', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                                        ...
                                        <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                                <div class="flex items-center">
                                                    <div class="whitespace-nowrap py-4 px-3 text-sm">
                                                        <a href="{{ route('second', ['hotel', 'edit-attribute-term']) }}" class="text-blue-600 hover:text-blue-800">
                                                            Extreme Adventure
                                                        </a>
                                                    </div>
                                                </div>
