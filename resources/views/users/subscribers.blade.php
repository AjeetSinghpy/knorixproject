@extends('layouts.vertical', ['title' => 'Subscribers', 'sub_title' => 'Apps', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap py-4 pe-3 text-sm">
                                        <div class="flex items-center">
                                            <div class="whitespace-nowrap py-4 px-3 text-sm">Phone</div>
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap py-4 px-3 text-sm">Ajeet Singh Bhadoriya</td>
                                    <td class="whitespace-nowrap py-4 px-3 text-sm">Rajput</td>
